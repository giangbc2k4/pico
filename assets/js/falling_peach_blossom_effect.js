var pictureSrc ="assets/img/hoa.svg"//Link ảnh hoa muốn hiển thị trên web
        var pictureWidth = 30; //Chiều rộng của hoa mai or đào
        var pictureHeight = 30; //Chiều cao của hoa mai or đào
        var numFlakes = 18; //Số bông hoa xuất hiện cùng một lúc trên trang web
        var downSpeed = 0.008; //Tốc độ rơi của hoa
